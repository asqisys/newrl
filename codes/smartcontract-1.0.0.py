...
class SecLoan1():
    ...
    def setup(self,callparams,activation_ts=None):
        ...
        if not activation_ts:   #user has chosen a fixed time to deploy, there may also be additional triggers through calls by an EOA
            params['next_act_ts']=activation_ts

...
#        transferfile_path = save_file_and_get_path(tfile)
    transferfile = FileResponse("data/tmp/transfernew.json", filename="transfer_transaction.json")
    return transferfile
...
async def create_token(
    ...
    return FileResponse(transaction_file, filename="create_token_transaction.json")
...
async def download_chain():
    return FileResponse("data/common/chain.json", filename="newrl_chain.json")

@app.get("/download-state")
async def download_state():
    return FileResponse("data/common/state.json", filename="newrl_state.json")
